...
1. In Visual Studio, right-click on the ChatAppRAG_Qdrant.AppHost project in the Solution Explorer and select "Manage User Secrets".
...
3. Once installed, Open the `Program.cs` file in the ChatAppRAG_Qdrant.AppHost project.
...
This template leverages JavaScript libraries to provide essential functionality. These libraries are located in the wwwroot/lib folder of the ChatAppRAG_Qdrant.Web project. For instructions on updating each dependency, please refer to the README.md file in each respective folder.
