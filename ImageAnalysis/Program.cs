...
var promptAnalyze = "wha's the type of yellow car ?";
    //"How many cars are in the picture and categories them with the color and put the count for each color ?";// and what other car colors are there?";
// prompts
